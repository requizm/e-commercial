...
export function Login() {
    ...
    async function handleChange(setEvent : any, event: ChangeEvent<HTMLInputElement>) {
        ...
        <form onSubmit={handleSubmit}>
            <div className="login-card-form">
                <div className="input-block email-block">
                    ...
                    <input type="text" name="email" placeholder="Enter" className="text-input email-input" autoComplete="off" onChange={e => handleChange(setEmail, e)} />
                </div>
                <div className="input-block password-block">
                    <div className="password-text">Password</div>
                    <input type="password" name="password" placeholder="Enter" className="text-input password-input" autoComplete="off" onChange={e => handleChange(setPassword, e)} />
                </div>
