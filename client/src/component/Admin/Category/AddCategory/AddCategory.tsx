        ...
        <form className="category-form" onSubmit={handleSubmit}>
            <div className="category-form-block">
                <div className="input-block name-block">
                    ...
                    <input type="text" placeholder="Enter" name="name" className="text-input name-input" autoComplete="off" onChange={e => {
                        setName(e.target.value);
                    }} />
                </div>
                <div className="input-block parent-block">
                    <div className="parent-text">Parent</div>
                    <select name="parent" className="text-input parent-select" autoComplete="off" onChange={e => setParent(e.target.value)} >
                        <option>None</option>
                        {
            ...
            <div className="category-form-bottom">
                <div className="add-button-block">
                    <input type="submit" id="add-button" className="btn disable-btn add-button" value="Add" />
                </div>
            </div>
        </form>
    </div>
