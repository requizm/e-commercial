...
export function UpdateCategory() {
    ...
    async function updateCategoryList() {
        ...
        const category: Category = categories.find((c: { id: number; }) => c.id === id);
        ...
        <form className="category-form" onSubmit={handleSubmit}>
            <div className="category-form-block">
                <div className="input-block name-block">
                    ...
                    <input type="text" placeholder="Enter" name="name" className="text-input name-input" autoComplete="off" value={name} onChange={e => {
                        setName(e.target.value);
                    }} />
                </div>
                <div className="input-block parent-block">
                    <div className="parent-text">Parent</div>
                    <select name="parent" className="text-input parent-select" autoComplete="off" value={parent.id} onChange={e => {
